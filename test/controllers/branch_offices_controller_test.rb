...
class BranchOfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch_office" do
    assert_difference('BranchOffice.count') do
      post branch_offices_url, params: { branch_office: { branch_office_email: @branch_office.branch_office_email, branch_office_name: @branch_office.branch_office_name, branch_office_phone: @branch_office.branch_office_phone } }
    end
  ...
  test "should update branch_office" do
    patch branch_office_url(@branch_office), params: { branch_office: { branch_office_email: @branch_office.branch_office_email, branch_office_name: @branch_office.branch_office_name, branch_office_phone: @branch_office.branch_office_phone } }
